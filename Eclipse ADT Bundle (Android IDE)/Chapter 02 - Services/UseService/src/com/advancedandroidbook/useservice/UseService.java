package com.advancedandroidbook.useservice;
...
import com.advancedandroidbook.useservice.R;
...
public class UseService extends Activity implements ServiceConnection {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stop.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				releaseBind();
				stopService(new Intent("com.advancedandroidbook.GPXService.SERVICE"));
			}
		});
		...
		getLastLoc.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					Log.e("ServiceControl", "Call to remote interface failed.",
							e);
				}
			}
...
//		bindService(new Intent("com.advancedandroidbook.GPXService.SERVICE"), this,
//				Context.BIND_AUTO_CREATE);
	}
