...
public class ShowGLCubeActivity extends Activity {
	public static final String WIREFRAME_OPTION_EXTRA = "WIREFRAME";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		doWireframe = starter.getBooleanExtra(WIREFRAME_OPTION_EXTRA, false);
	...
	private class BasicGLThread extends Thread {
		private static final String DEBUG_TAG = "ShowGLCubeActivity$BasicGLThread";
		SurfaceView sv;
		...
		public void run() {
			try {
				...
				while (!mDone) {
					...
					CubeSmallGLUT.drawSimpleCube(mGL, doWireframe);
