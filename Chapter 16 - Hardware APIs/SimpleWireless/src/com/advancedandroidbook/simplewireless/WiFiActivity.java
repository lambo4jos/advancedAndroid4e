	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scan.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				wifi.startScan();
				registerReceiver(rcvWifiScan, new IntentFilter(
						WifiManager.SCAN_RESULTS_AVAILABLE_ACTION));
				Toast.makeText(WiFiActivity.this, "Scan started",
		...
		listKnown.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				ListIterator<WifiConfiguration> configs = wifi
						.getConfiguredNetworks().listIterator();
	...
	protected void onPause() {
		if (rcvWifiScan != null) {
			try {
				...
				// drop it, receivers not registered thrown an exception
			}
			rcvWifiScan = null;
		}
		super.onPause();
